...
class Player(object):
    ...
    def go_to(self, location):
        ...
        You are at GBC
        """
        # this is to return the object of location
        ...
        if destination_place.locked:
            ...
            # check the get_neighbour function and u will know
        else:
    ...
    def talk_to(self, person):
        ...
        # here I need to use elif, if u use if, then it does not 
        # satisfy, then the next else would be executed
    ...
    def unlock(self, place):
        ...
        # first see whether the door is locked or not
