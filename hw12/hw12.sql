...
CREATE TABLE sentences AS
  SELECT a.name1 || ' and ' || a.name2 || ' are ' || size1.size || ' siblings'
  FROM siblings as a, size_of_dogs as size1, size_of_dogs as size2
  WHERE a.name1 = size1.name AND a.name2 = size2.name  AND size1.size = size2.size;
